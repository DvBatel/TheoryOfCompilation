...
namespace ast
{
    ...
    public:
        ...
        int line;
        //perimitive, numbers or variable/ func names
        std::string type_def;
        //check if node is return
        bool isReturn = false;
    ...
    public:
        ...
        std::vector<std::shared_ptr<Exp>> getExpList();
    };
    ...
    public:
        ...
        // this is for us not for statements no formals for you
        ...
        void insertFormals(std::vector<std::shared_ptr<Formal>> formals);

        std::vector<std::shared_ptr<Formal>> getFormals();
    };
    ...
    public:
        ...
        std::shared_ptr<Statements> getStatememts();
    };
